...
/**
 * The selectable RSI look-back periods, all computed on daily/weekly/monthly
 * candles. Shorter periods react faster and suit shorter holds — for a
 * buy-oversold-sell-within-a-week swing strategy, RSI(5) or Connors' RSI(2)
 * on DAILY bars is the standard entry-timing tool (intraday-minute RSI is a
 * scalping signal, and the free PSX feed has no intraday history anyway).
 * The conventional oversold/overbought thresholds widen as the period
 * shrinks, because a short RSI swings much harder: 14 → 30/70, 5 → 20/80,
 * 2 → 10/90.
 */
export const RSI_PERIODS = [
  { period: 14, label: "RSI(14) · standard", oversold: 30, overbought: 70 },
  { period: 9, label: "RSI(9) · fast", oversold: 30, overbought: 70 },
  { period: 5, label: "RSI(5) · swing", oversold: 20, overbought: 80 },
  { period: 2, label: "RSI(2) · Connors", oversold: 10, overbought: 90 },
];
